...
public class TamperingErrorScreen extends Screen {
    ...
    public void init() {
        ...
        this.addDrawableChild(ButtonWidget.builder(Text.translatable("text." + ModObserver.MOD_ID + ".issue_tracker"), button -> ConfirmLinkScreen.open(this, "https://curseforge.com/minecraft/mc-mods/mod-observer/issues")).dimensions((this.width / 2) - 150, height - 25, 150, 20).build());
        this.addDrawableChild(ButtonWidget.builder(Text.translatable("text." + ModObserver.MOD_ID + ".discord"), button -> ConfirmLinkScreen.open(this, "https://discord.gg/nNYHDryaj3")).dimensions((this.width / 2) + 10, height - 25, 150, 20).build());
        height = height + 30;
